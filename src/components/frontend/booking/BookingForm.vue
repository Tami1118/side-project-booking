...
const { userInfo, userInfoTemp } = storeToRefs(userStore);
...
<template>
  <div class="flex mb-8 lg:mb-10">
    ...
    <button class="btn-text ms-auto underline" @click="userInfoTemp.name = userInfo.name, userInfoTemp.phone = userInfo.phone, userInfoTemp.email = userInfo.email, userAddressRef.getAddress()">套用會員資料</button>
  </div>
